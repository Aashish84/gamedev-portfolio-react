...
export default [
  {
    ...
    intro:
      "A 2.5D platformer game that focuses on movement with character controller and some game features.",
    desc: "I finished and completed this 2.5D platformer game and created a working moveable player from the scratch using character controller being able to run, jump, roll, etc using some awesome animations. I also converted the concept for ledge grab system, ladder climb, elevator, moving platform to the actual working feature in this game. This took me 1 month to complete this project.",
  },
  {
    id: 2,
